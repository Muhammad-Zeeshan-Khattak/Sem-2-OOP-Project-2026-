...
class CartItem {
    ...
    double total() { return product.getPrice() * qty; }
}
...
class SmartShopGUI {
    ...
    private static void showAdminScreen() {
        ...
        btnPanel.setBackground(BG_COLOR);
        JButton addBtn = new JButton("Add Product"); styleButton(addBtn, BLUE_ACCENT);
        JButton updateBtn = new JButton("Update Product"); styleButton(updateBtn, new Color(156, 39, 176)); 
        JButton deleteBtn = new JButton("Delete Selected"); styleButton(deleteBtn, RED_ACCENT);
        ...
        JButton logoutBtn = new JButton("Logout"); styleButton(logoutBtn, RED_ACCENT.darker());
        ...
        addBtn.addActionListener(e -> {
            try (Connection conn = DB.getConnection()) {
                ...
                p1.setInt(1, Integer.parseInt(idF.getText())); p1.setString(2, nameF.getText());
                p1.setString(3, typeF.getText()); p1.setDouble(4, Double.parseDouble(priceF.getText()));
                p1.setInt(5, Integer.parseInt(qtyF.getText())); p1.executeUpdate();

                PreparedStatement p2 = conn.prepareStatement("INSERT INTO ProductDetails VALUES (?, ?, ?, ?, ?)");
                p2.setInt(1, Integer.parseInt(idF.getText())); p2.setString(2, brandF.getText());
                p2.setString(3, sizeF.getText()); p2.setString(4, colorF.getText());
                p2.setString(5, materialF.getText()); p2.executeUpdate();
        ...
        updateBtn.addActionListener(e -> {
            try (Connection conn = DB.getConnection()) {
                ...
                p1.setString(1, nameF.getText()); p1.setString(2, typeF.getText());
                p1.setDouble(3, Double.parseDouble(priceF.getText())); p1.setInt(4, Integer.parseInt(qtyF.getText()));
                ...
                p2.setString(1, brandF.getText()); p2.setString(2, sizeF.getText());
                p2.setString(3, colorF.getText()); p2.setString(4, materialF.getText());
    ...
    private static void showUserScreen(String username) {
        ...
        JTable pTable = new JTable(pModel); styleTable(pTable);
        JScrollPane pScroll = new JScrollPane(pTable); pScroll.getViewport().setBackground(BG_COLOR);
        ...
        JPanel pPanel = new JPanel(new BorderLayout(5, 5)); stylePanel(pPanel, "Available Store Items");
        pPanel.add(pScroll, BorderLayout.CENTER);
        JButton addCartBtn = new JButton("Add Selected to Cart"); styleButton(addCartBtn, BLUE_ACCENT);
        ...
        JButton logoutBtn = new JButton("Logout"); styleButton(logoutBtn, RED_ACCENT);
